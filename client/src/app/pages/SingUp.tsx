...
const SignUp = () => {
  ...
  return (
    <div className="w-full min-h-[100vh] bg-background bg-no-repeat bg-center bg-cover">
      <div className="bg-[#FFFF] w-[598px] px-[74px] py-[77px] rounded-2xl flex flex-col content-center items-center absolute top-[20%] left-[50%] shadow-inner shadow-white-gainsboro">
