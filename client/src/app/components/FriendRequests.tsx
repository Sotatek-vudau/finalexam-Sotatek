const FriendRequets = () => {
    return(
        <div className="w-[276px] flex flex-col p-[24px] bg-[#FFFF] rounded-[20px] mt-[32px]">
            <div>
                <p className="text-[14px] font-semibold pb-[18px] border-b-[1px] border-b-solid border-b-[#F1F1F1]">FRIEND REQUETS</p>
            </div>
            <div className="mt-[18px]">
                <div className="flex flex-col mb-[24px]">
                    <div className="flex flex-row">
                        <img src="https://img2.thuthuatphanmem.vn/uploads/2018/12/08/hinh-anh-nobita-hai-huoc_105846767.jpg" className="w-[50px] h-[50px] rounded-full mr-[9px]"/>
                        <div>
                ...
                <div className="flex flex-col mb-[24px]">
                    <div className="flex flex-row">
                        <img src="https://i0.wp.com/thatnhucuocsong.com.vn/wp-content/uploads/2022/04/hinh-anh-xuka-de-thuong-nhat.jpg?fit=780%2C439&ssl=1" className="w-[50px] h-[50px] rounded-full mr-[9px]"/>
                        <div>
