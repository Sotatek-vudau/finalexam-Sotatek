const InfoUser = () => {
    return(
        <div className="w-[276px] flex flex-col p-[24px] bg-white rounded-[20px] mt-[32px]">
            <div className="flex flex-row pb-[16px] border-b-[1px] border-b-solid border-b-[#F1F1F1]">
                ...
                <div className="flex flex-col items-start">
                    <p className="text-[14px] font-semibold text-[#29282B]">Doraemon</p>
                    <p className="text-[14px] font-normal text-[#ACACAC]">Japan</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-start py-[16px]">
                ...
                <button className="w-[100%] h-[35px] bg-[#FFFF] rounded-[10px] border-[1px] border-solid border-[#EAEAEA]" >Edit</button>
            </div>
        </div>
    );
}
